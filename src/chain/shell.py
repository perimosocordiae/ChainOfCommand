...
class Shell(object):
    ...
    def load_finished(self):
        ...
        self.screen.accept('enter',self.staging_ready)
        ...
        self.screen.accept('page_up', self.g.send_level_change, [1])
        self.screen.accept('page_down', self.g.send_level_change, [-1])
