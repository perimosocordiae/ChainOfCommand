...
environ = loader.loadModel("./yellow_floor.egg")
...
for z in range(0, center / 2):
  tile = loader.loadModel("./blue_floor.egg")
  tile.reparentTo(environ)
  tile.setScale(1.0, 1.0, 1.0)
...
actor = Actor.Actor("./terminal_window.egg")
...
tron = Actor.Actor("./tron", {"running":"tron_anim"})
